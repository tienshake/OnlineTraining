...
export default function ChatBox() {
    const { handleCloseChatBot } = useContext(ChatBotContext);
    return (
        <>
                        ...
                        <div className="card">
                            ...
                            <div id="chatbox-area">
                                    ...
                                    <div className="content">
                                        <div className="chat-message-group">
                                            ...
                                            <div className="chat-messages">
                                                <div className="message">Chào mừng</div>
                                ...
                                <footer className="card-footer" id="chatBox-textbox">
                                    <div style={{ width: '100%' }}>
                                        <textarea id="chatTextarea" className="chat-textarea" placeholder="Digite aqui"/*  v-on:focus="expandTextArea()" */ /* v-on:blur="dexpandTetArea()" */></textarea>
                                    </div>
                                    <div className="has-text-centered" style={{ width: "100%", background: '#fff' }}>
                                        <a className="button is-white">
                                            <i className="fa fa-smile-o fa-5" aria-hidden="true"></i>
                                        </a>
                                        <a className="button is-white">Gửi</a></div>
                                </footer>
                            </div>
                        </div>
                    </div >
