                            ...
                            <div id="chatbox-area">
                                <div className="card-content chat-content">
                                    <div className="content">
                                        ...
                                        {talkContent.map((content: { role: string, message: string }, index: number) => (
                                            <div key={index}>
                                                {
                                                    content.role === 'user' ? (
                                ...
                                <footer className="card-footer" id="chatBox-textbox">
                                    <div style={{ width: '100%' }}>
                                        <textarea value={valueInputMessage} onChange={handleChangeMessage} id="chatTextarea" className="chat-textarea" placeholder="Nhập tin nhắn"></textarea>
                                    </div>
                                    <div className="has-text-centered" style={{ width: "100%", background: '#fff' }}>
                                        <a className="button is-white">
                                            <i className="fa fa-smile-o fa-5" aria-hidden="true"></i>
                                        </a>
                                        <p style={{ cursor: 'pointer' }} onClick={handleSubmitMessage} className="button is-white">Gửi</p>
                                    </div>
                                </footer>
                            </div>
                        </div>
