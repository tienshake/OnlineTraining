...
import { editUserById, getDataDetailUser } from "../redux/features/userTeacher/userTeacherSlice";
...
export default function Profile() {
  ...
  const { isLoading, messageError, messageSuccessEditTeacher, errorEditUserTeacher } = userStore;
  ...
  const handleInputChange = (e: any) => {
    ...
    setInputs((state) => ({ ...state, [nameInput]: valueInput === '' ? undefined : valueInput }));
  };
