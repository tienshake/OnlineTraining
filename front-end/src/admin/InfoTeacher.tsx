      ...
      <MasterLayoutAdmin>
        ...
        <div className="wrapp_teacherInfo">
          <div className="content-left">
            <CardUser
              name="ss"
              decription="The purpose of lorem ipsum is to create a natural looking block of text (sentence, paragraph, page, etc.) that doesn't distract from the layout. A practice not without controversy, laying out pages with meaningless filler text can be very useful when the focus is meant to be on design, not content."
            />
              ...
              <>
                <div key={index}>
                  <div className="box_reviews_user">
                    <img
                      src="https://www.pixelwibes.com/template/e-learn/html/dist/assets/images/xs/avatar3.jpg"
                      alt=""
                    />
                    <p>
                      <b>Diane Fishe</b>r 450 Followers <br />3 hours ago
                      @RobertHammer
                    </p>
                    ...
                    <p className="decritions">
                      "Excellent balance of lecture, live playing and
                      recordings. Cecilia possesses a great sense of humor. So
                      well researched, so engaging both as a lecturer and a
                      pianist."
                    </p>
                  </div>
                </div>
